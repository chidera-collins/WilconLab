...
function PricingComponent5() {
  return (
    <div>
<div className='min-h-[1700px] w-full bg-boldtext p-[10px] md:hidden'>
            ...
            <div className='min-h-[200px]  gap-5 grid p-[10px]'>
                <div className='min-h-[420px] border-t-[5px] border-t-textc bg-[#ecf0f128] p-[10px]'>
                 <div>
                 ...
                 <div className='mt-2'>
                    <h1 className='capitalize font-custom font-extrabold text-white text-[1.3rem]'>basic health check</h1>
                 </div>
                 <div className='mt-5 leading-8'>
                    <ul className='capitalize ddotted-list font-custom font-medium text-white'>
                ...
                <div className=' min-h-[400px] p-[10px] border-t-[5px] border-t-[red] bg-[#ffffff5b]'>
                    <div>
                ...
                <div className='min-h-[400px]  border-t-[5px] border-t-[green] bg-[#ecf0f128] p-[10px]'>
                        <div>
