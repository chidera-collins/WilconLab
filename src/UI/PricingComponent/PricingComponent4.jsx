...
function PricingComponent4() {
  return (
    <div>
         <div className='min-h-[100px] w-full bg-white p-[10px] dark:text-black hidden md:hidden lg:block'>
            ...
            <div className='min-h-[200px] grid grid-cols-3 p-[50px]'>
                <div className='h-[550px] border-t-[5px] border-t-boldtext bg-bodybg p-[10px]'>
                 <div>
                ...
                <div className=' h-[600px] p-[10px] border-t-[5px] mt-[-15px] border-t-[red] bg-white shadow-[#00000060] shadow-2xl'>
                    <div>
                ...
                <div className='h-[550px]  border-t-[5px] border-t-[green] bg-bodybg p-[10px]'>
                        <div>
