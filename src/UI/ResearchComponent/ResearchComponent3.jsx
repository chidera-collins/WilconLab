...
function ResearchComponent3() {
  ...
  return (
    <div className='mt-[40px] hidden md:block lg:hidden p-[10px]'>
        <div className={`min-h-[500px] w-full grid grid-cols-2 gap-[30px] transition-opacity duration-300 ${transitioning ? 'opacity-0' : 'opacity-100'}`}>
