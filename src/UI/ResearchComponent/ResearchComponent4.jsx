...
function ResearchComponent4() {
  ...
  return (
    <div className='mt-[40px] hidden md:hidden lg:block p-[30px] box-border'>
        <div className={`min-h-[500px] p-[30px] w-full grid grid-cols-3 gap-[30px] transition-opacity duration-300 ${transitioning ? 'opacity-0' : 'opacity-100'}`}>
            {records.map((dat,index) =>(

                <div key={index} className="card card-compact bg-base-100 w-90 shadow-xl">
                    <figure>
                        <img
                        src={dat.img}
                    ...
                    <div className="card-body">
                        ...
                        <h2 className="card-title font-custom text-[25px] text-boldtext">{dat.title}</h2>

                        <p>{dat.about}</p>
                        <div className="card-actions justify-start">
                        <button className="btn text-2xl text-bodybg font-custom hover:opacity-60"  style={{backgroundColor:colors[index % colors.length], }}>READ MORE</button>
                        </div>
                    </div>
                </div>
            ))}
