...
function ServicesComponent6() {
  return (
    <div>
        <div className='min-h-[100px] w-full bg-white p-[10px] hidden md:hidden lg:block'>
            ...
            <div className='min-h-[200px] grid grid-cols-3 p-[20px]'>
                <div className='min-h-[420px] border-t-[5px] border-t-boldtext bg-bodybg p-[10px]'>
                 <div>
                ...
                <div className=' min-h-[400px] p-[10px] border-t-[5px] mt-[-15px] border-t-[red] bg-white'>
                    <div>
                ...
                <div className='min-h-[400px]  border-t-[5px] border-t-[green] bg-bodybg p-[10px]'>
                        <div>
...
export default ServicesComponent6